...
import { useAbsensiByIsPrivate } from "../../services/API_Query";
  ...
  return (
    <>
                ...
                (Absensi: any, index: number) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                      <Badge
                        variant="light"
                        color={Absensi.jenis === "DATANG" ? "success" : "info"}
                      >
                        {Absensi.jenis}
                      </Badge>
                    </TableCell>
            ...
            <div className="w-full flex justify-end items-center">
              ...
              ${
                ...
                <button
                  onClick={() =>
                    setPage((old) =>
                      old + 1 < (Absensis as any).totalPages ? old + 1 : old,
                    )
                  }
      ...
      <dialog ref={detailRef} className="modal modal-bottom sm:modal-middle">
        <div className="modal-action">
          <div className="modal-box min-w-md dark:bg-black border-white border">
